...
export const CITIES = [
  "abbottabad", "attock", "badin", "bahawalpur", "bannu", "batkhela", "bhakkar",
  "burewala", "chaman", "charsadda", "chiniot", "chishtian", "chitral", "dadu",
  "daska", "dera-ghazi-khan", "dera-ismail-khan", "dera-murad-jamali", "faisalabad",
  "ghotki", "gilgit", "gojra", "gujar-khan", "gujranwala", "gujrat", "gwadar",
  "hafizabad", "hangu", "haripur", "hasilpur", "hub", "hyderabad", "islamabad",
  "jacobabad", "jamshoro", "jaranwala", "jhang", "jhelum", "kamalia", "kamoke",
  "kandhkot", "karachi", "kashmore", "kasur", "khairpur", "khanewal", "khuzdar",
  "kohat", "kotli", "kot-addu", "lahore", "larkana", "layyah", "lodhran", "loralai",
  "mandi-bahauddin", "mansehra", "mardan", "mianwali", "mingora", "mirpur",
  "mirpur-khas", "multan", "muridke", "muzaffarabad", "muzaffargarh", "narowal",
  "nawabshah", "nowshera", "okara", "pakpattan", "peshawar", "quetta",
  "rahim-yar-khan", "rawalpindi", "sadiqabad", "sahiwal", "sargodha", "shahdadkot",
  "shahdadpur", "sheikhupura", "shikarpur", "sialkot", "sibi", "skardu", "sukkur",
  "swabi", "tando-adam", "tando-allahyar", "taxila", "thatta", "timergara",
  "toba-tek-singh", "turbat", "vehari", "wah-cantt", "wazirabad", "zhob",
];
