...
const SERVICES = [
  {
    ...
    desc: "Hire a verified inspector to check a heavy vehicle before you buy — or join as an inspector yourself.",
    href: "/services/inspection",
  },
  {
    icon: "📊",
    title: "Price Guide",
    desc: "See typical market prices for each vehicle type, based on real HeavyWheels listings.",
    href: "/services/price-guide",
  },
  {
    icon: "💰",
    title: "Loan Calculator",
    desc: "Estimate your monthly installment for truck and machinery financing in seconds.",
    href: "/services/loan-calculator",
  },
  {
    icon: "📄",
    title: "Ownership Transfer",
    desc: "Hassle-free help transferring vehicle registration and documents — tracked to completion.",
    href: "/services/transfer",
  },
  {
    icon: "🛡️",
    title: "Warranty Program",
    desc: "Spot dealers who back their vehicles with their own verified warranty.",
  ...
  return (
    <main className="hw-container py-10">
      <div className="mx-auto max-w-5xl">
        <p className="text-xs font-black uppercase text-[var(--hw-orange)]">HeavyWheels</p>
        <h1 className="mt-2 text-3xl font-black text-[var(--hw-text-primary)] md:text-4xl">Our Services</h1>
        <p className="mt-2 max-w-2xl text-sm text-[var(--hw-text-muted)]">
          Everything you need to buy and sell heavy vehicles with confidence — from inspection and
          financing to price guidance and paperwork.
        </p>
          ...
          {SERVICES.map((s) =>
            s.href ? (
              ...
              >
                ...
                <span className="mt-4 text-sm font-bold text-[var(--hw-orange)]">Open →</span>
              </Link>
            ) : (
              <div
                key={s.title}
